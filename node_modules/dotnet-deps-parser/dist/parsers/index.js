...
function getDependencyTreeFromProjectFile(manifestFile, includeDev = false) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const name = (nameProperty.PackageId && nameProperty.PackageId[0])
            ...
            || '';
        const packageReferenceDeps = yield getDependenciesFromPackageReference(manifestFile, includeDev);
        const referenceIncludeDeps = yield getDependenciesFromReferenceInclude(manifestFile, includeDev);
...
function getDependenciesFromPackageReference(manifestFile, includeDev = false) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function processItemGroupForPackageReference(packageList, manifestFile, includeDev, dependenciesResult) {
    ...
    for (const dep of packageList.PackageReference) {
        ...
        const subDep = buildSubTreeFromPackageReference(dep, isDev, manifestFile, targetFrameworks);
...
function getDependenciesFromReferenceInclude(manifestFile, includeDev = false) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        referenceIncludeResult =
            processItemGroupForReferenceInclude(referenceIncludeList, manifestFile, includeDev, referenceIncludeResult);
        return referenceIncludeResult;
    });
}
function processItemGroupForReferenceInclude(packageList, manifestFile, includeDev, dependenciesResult) {
    const targetFrameworks = _.get(packageList, '$.Condition', false) ?
        getConditionalFrameworks(packageList.$.Condition) : [];
    for (const item of packageList.Reference) {
        ...
        const subDep = buildSubTreeFromReferenceInclude(depInfo, isDev, manifestFile, targetFrameworks);
        if (subDep.withoutVersion) {
            dependenciesResult.dependenciesWithUnknownVersions = dependenciesResult.dependenciesWithUnknownVersions || [];
            dependenciesResult.dependenciesWithUnknownVersions.push(subDep.name);
        }
...
function buildSubTreeFromReferenceInclude(dep, isDev, manifestFile, targetFrameworks) {
